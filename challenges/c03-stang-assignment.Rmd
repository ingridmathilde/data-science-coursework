...
**For small thicknesses (<0.08 in), the Young's modulus is higher than the quoted value.**
```{r q3-plotting2}
...
**For small thicknesses (<0.08 in), the Poisson's ratio is higher than the quoted value. For 0.081 in thickness, the measured Poisson's ratio is slightly lower.**
